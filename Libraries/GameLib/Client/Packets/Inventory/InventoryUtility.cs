...
namespace SilkroadInformationAPI.Client.Packets.Inventory
{
    class InventoryUtility
    {
        ...
        public static Information.InventoryItem PareseOperatedItem(Packet p)
        {
            p.ReadUInt32();
        ...
        public static Information.InventoryItem ParseItemBoughtFromMall(Packet p)
        {
            uint itemID = p.ReadUInt16();
            Information.InventoryItem item = new Information.InventoryItem(itemID);
            Console.WriteLine(p.ReadUInt8()); //U
            Console.WriteLine(p.ReadUInt8());
            Console.WriteLine(p.ReadUInt8());
            Console.WriteLine(p.ReadUInt8());
