...
namespace ImageLibrary.GDImageLibrary
{
    class DDSReader
    {

        public Order ARGB = new Order(16, 8, 0, 24);
        public Order ABGR = new Order(0, 8, 16, 24);
        ...
        public int[] read(byte[] buffer, Order order, int mipmapLevel)
        {
